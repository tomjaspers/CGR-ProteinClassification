...
PDB_URL = 'http://www.rcsb.org/pdb/download/downloadFile.do?fileFormat=FASTA&compression=NO&structureId={0}'
PFAM_URL = 'http://pfam.xfam.org/family/{0}/alignment/seed/format?format=pfam&alnType=seed&order=t&case=u&gaps=none&download=0'
